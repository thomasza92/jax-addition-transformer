...
from data.tokenizer import PAD_ID, encode, stoi
...
def make_example(
  ...
  if answer_only_loss:
    ...
    mask = [1.0 if target_id != PAD_ID else 0.0 for target_id in y]
...
def make_batch(
  ...
  if answer_only_loss:
    ...
    position_mask = (target_positions >= 8) & (target_positions <= 11)
